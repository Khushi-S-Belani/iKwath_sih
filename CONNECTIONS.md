...
| **4** | **DHT11 Sensor**<br>*(Temp & Humidity)* | DATA (Signal)<br>VCC (+)<br>GND (-) | **GPIO 15**<br>—<br>**GND** | **+3.3V** (or 5V)<br>**+3.3V** (or 5V)<br>Common **GND** | **Green**<br>**Red / Orange**<br>**Black** | Single-Wire<br>Digital Protocol | Samples live temperature (0–50°C). Shuts Relay 1 heater OFF at **35°C**. |
