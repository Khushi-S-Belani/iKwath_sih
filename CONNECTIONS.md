...
| **5** | **`STIRRING`** | Stepper Driver (GPIO 13,12,19,23) ON | Internal Timer | **30 Seconds** | 28BYJ-48 stepper agitates chamber for 30s. All 4 driver coils de-energize to LOW. |
